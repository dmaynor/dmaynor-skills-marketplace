...
description: >-
  Locate and validate the correct arm64e kernel or per-model kernelcache on
  Apple Silicon macOS. Use when capturing update baselines, selecting binaries
  for kernel or kext comparison, or diagnosing an architecture mismatch. Treat
  model and board mappings as dated observations requiring verification.
metadata:
  author: Claude Code
  version: 1.0.0
  date: 2026-05-31
